          ...
          <div className="mx-auto max-w-5xl">
            ...
            <div className="grid gap-8 md:grid-cols-3">
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="mb-2 text-xl font-semibold text-foreground">Comprehensive Library</h3>
                <p className="text-muted-foreground">
                  Access detailed information about PMBOK 7, PRINCE2, and ISO 21500/21502 in one place.
                </p>
              </div>
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="mb-2 text-xl font-semibold text-foreground">Side-by-Side Comparison</h3>
                <p className="text-muted-foreground">
                  Compare how different standards approach the same topics and identify best practices.
                </p>
              </div>
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="mb-2 text-xl font-semibold text-foreground">Tailored Recommendations</h3>
                <p className="text-muted-foreground">
                  Get customized process recommendations based on your project's unique characteristics.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mx-auto max-w-5xl">
            <div className="grid gap-8 md:grid-cols-3">
              <div className="text-center">
                ...
                <div className="text-sm uppercase tracking-wide text-muted-foreground">Global Standards</div>
              </div>
              <div className="text-center">
                <div className="mb-2 text-4xl font-bold text-accent">33</div>
                <div className="text-sm uppercase tracking-wide text-muted-foreground">Key Topics Covered</div>
              </div>
              <div className="text-center">
                <div className="mb-2 text-4xl font-bold text-success">100%</div>
                <div className="text-sm uppercase tracking-wide text-muted-foreground">Free to Use</div>
              </div>
            </div>
          </div>
        </div>
